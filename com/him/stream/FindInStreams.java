...
public class FindInStreams {
	static List<Employee> employeeList = Arrays.asList(new Employee("Tom Jones", 45), new Employee("Harry Major", 25),
			...
			new Employee("Billy Kid", 22), new Employee("George King", 44), new Employee("Annie Barrey", 19));
	...
	public static void main(String[] args) {
		...
		if (firstEmpBelow30.isPresent()) {
			System.out.println("First employee below 30: " + firstEmpBelow30.get().getName());
		}
	}
}